...
master1=177.178.179.21
master2=177.178.179.22
master3=177.178.179.23
worker1=177.178.179.24
worker2=177.178.179.25
...
# Set the virtual IP address (VIP) for the cluster hight availability (HA)
vip=177.178.179.100
...
lbrange=177.178.179.60-177.178.179.80
